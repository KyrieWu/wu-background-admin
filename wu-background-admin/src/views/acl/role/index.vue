<template>
  <div style="width: 100%;height: 100%;">
    <el-card style="height: 75px;">
      <el-form :inline="true" class="form">
        <el-form-item label="职位搜索:">
          <el-input placeholder="请您输入搜索角色的关键字"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-card style="margin-top: 10px;height: calc(100% - 85px);overflow: auto;">
      <el-button type="primary" size="default" icon="Plus" @click="addRole">
        添加角色
      </el-button>
      <el-table border style="margin: 10px 0" :data="allRole" v-loading="loading">
